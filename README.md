...
existing `api`. If a future consumer needs a shared management surface the analysis
will be re-run (per the Component Standard's front-end tooling decision).
